...
#define STRING_CONFIG_H_AUTHOR "(Inkognito, x5sa-pro skr 1_4 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "X5SA-Pro V6 330 SKR1_4 Turbo"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -54, -12, -1 }
